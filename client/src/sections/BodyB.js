          ...
          {/* First grid spot */}    
            <div>
              <h4 className="sub-header">Make a profile & save recipes</h4>
                  ...
                  {Button && <Button linkTo='/profile' buttonStyle='btn--body' buttonSize='btn--medium'>Profile</Button>} 
            </div>
        ...
        {/* First grid spot */}    
          <div>
            <h4 className="sub-header">Make a profile & save recipes</h4>
                ...
                {Button && <Button linkTo='/log-in' buttonStyle='btn--body' buttonSize='btn--medium'>Log In</Button>} 
          </div>
